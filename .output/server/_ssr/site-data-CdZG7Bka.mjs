//#region node_modules/.nitro/vite/services/ssr/assets/site-data-CdZG7Bka.js
var PORTRAIT_MAIN = "https://static.wixstatic.com/media/2cc3d5_aab64f51dba646bab82b67716b9696b5~mv2.jpeg/v1/fill/w_1200,h_1400,fp_0.50_0.40,q_85,enc_avif,quality_auto/Bc_%20Jan%20Hotovec.jpeg";
var PORTRAIT_STORY = "https://static.wixstatic.com/media/2cc3d5_3e6cc63bee5a440b92ee6589c72b9c15~mv2.jpeg/v1/fill/w_900,h_1100,fp_0.50_0.40,q_85,enc_avif,quality_auto/Bc_%20Jan%20Hotovec%20.jpeg";
var W = (id, name) => `https://static.wixstatic.com/media/2cc3d5_${id}~mv2.png/v1/fill/w_1600,h_1000,q_90,enc_avif,quality_auto/${encodeURIComponent(name)}.png`;
var PROJECTS = [
	{
		slug: "zpomal",
...
var TESTIMONIALS = [
	...
	},
	{
		...
		quote: "S Honzou (p. Hotovcem) se velmi dobře spolupracovalo. Má profesionální přístup a vytvořené stránky stojí za to. Vhodně hledal řešení k mým potřebám. V komunikaci nebyl problém, co šlo jsme vyřešili po e-mailu anebo osobně."
	},
	{
		name: "Michal Farský",
		role: "BSS Home",
		year: "2025",
		url: "https://janhotovec98.wixstudio.com/bssh",
		quote: "Spolupráce s Honzou byla naprosto v pořádku, jeho akční přístup, nápady a zpracování mě bavilo. Výsledkem jsou krásné čisté stránky, které neprosto splňují mojí představu. Určitě doporučuji!"
	},
	{
	...
	},
	{
		...
		quote: "Honza je nadaný, empatický a upřímný mladý muž. Kreativní a svědomitý v přípravě i plnění zadání. Práce s ním je vždy okořeněna humorem. Je týmový hráč, který umí, jak přijmout, tak i předat zpětnou vazbu. V rámci jeho vady řeči stačí trochu trpělivosti naslouchat nebo komunikovat písemně. Tvorba a správa webů ho naplňuje a dává mu prostor pro seberealizaci se skvělými výsledky. Doporučuji … získáte člověka se zdravými hodnotami, úsměvem, s neuvěřitelnou chutí a pokorou se životu a výzvám postavit čelem. Jako jeho mentor jsem na jeho posuny „pyšná“."
	},
	{
...
//#endregion
export { TESTIMONIALS as a, REASONS as i, PORTRAIT_STORY as n, PROJECTS as r, PORTRAIT_MAIN as t };
