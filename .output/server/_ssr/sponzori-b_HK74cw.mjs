...
//#region node_modules/.nitro/vite/services/ssr/assets/sponzori-b_HK74cw.js
...
var partners = [
	...
	},
	{
		...
		links: [{
			label: "Facebook",
			href: "https://www.facebook.com/profile.php?id=100064310366625"
		}]
	},
	{
		name: "Geoprint s.r.o.",
		...
		links: [{
			label: "Web",
			href: "https://www.geoprint.cz/"
		}]
	},
	{
		name: "Fitness Life Liberec",
		text: "Díky velkorysosti Fitness Life Liberec mám možnost pravidelně využívat jejich moderní fitness centrum. Tento přístup mi umožňuje udržovat se v kondici a zlepšovat své fyzické zdraví.\n\nOceňuji také profesionální přístup jejich trenérů, kteří jsou vždy připraveni poradit a motivovat mě k dosažení mých cílů.\n\nJejich podpora je pro mě nesmírně cenná a velmi si jí vážím.",
		links: [{
			label: "Web",
			href: "https://fitnesslifeliberec.cz/"
		}]
	},
	{
		name: "Level UP Liberec",
		text: "Velké poděkování patří Level Up Fitness za vstřícnost a podporu v podobě umístění mých letáků a především za možnost trénovat v jejich moderním, privátním fitness prostředí.\n\nTato spolupráce pro mě znamená nejen lepší přístup k pravidelnému tréninku, ale i motivaci posouvat se dál — fyzicky i mentálně.\n\nDěkuji za otevřenost, profesionální přístup a důvěru, které si opravdu vážím.",
		links: [{
			label: "Web",
			href: "https://lvlupfitness.cz/"
		}]
	},
	{
	...
	},
	{
		...
		links: [{
			label: "Web",
			href: "https://www.nordbeans.cz/provozovny/3/kavarna-lazne"
		}]
	},
	{
		...
		links: [{
			label: "Facebook",
			href: "https://www.facebook.com/vinotekadvoudecka"
		}]
	},
	{
	...
	{
		name: "Ivana Kudrnová",
		text: "Mentorka, webdesignérka a osobní koučka. Naše spolupráce v oblasti webdesignu v Praze je pro mě nesmírně cenná.\n\nIvana je empatická, upřímná a vždy připravena naslouchat. Její terapie zaměřené na práci s energií jsou obohacující.",
		links: [{
			label: "Web",
			href: "https://www.ivanakudrnova.com/"
		}]
	}
];
function initials(name) {
	return name.replace(/spol\.|s\.r\.o\.|s r\.o\.|a\.s\./gi, "").trim().split(/\s+/).slice(0, 2).map((w) => w[0]?.toUpperCase() ?? "").join("");
}
function Sponzori() {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "mx-auto max-w-[1100px] px-6 pt-20 pb-10 md:px-10 md:pt-28",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-8 max-w-2xl space-y-5 text-lg leading-relaxed text-muted-foreground md:text-xl",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Rád bych z celého srdce poděkoval za jakoukoli podporu od sponzorů a dárců. Díky jejich pomoci mohu lépe udržovat svou kondici, pracovat na sobě a usnadňovat si každodenní život pomocí kompenzačních pomůcek." }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Každý příspěvek — finanční, materiální, praktický nebo ve formě času a důvěry — má pro mě velkou hodnotu." }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Pokud se chcete přidat k mým sponzorům a dárcům, budu rád, když se mi ozvete." }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Ještě jednou děkuji za vaši důvěru a podporu." }),
						...
						children: partners.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-background/60 font-display text-lg font-semibold text-primary ring-1 ring-primary/15",
										children: initials(p.name)
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "min-w-0 font-display text-lg leading-tight md:text-xl",
										children: p.name
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "mt-5 flex-1 space-y-3 text-[0.95rem] leading-relaxed text-muted-foreground",
									children: p.text.split("\n\n").map((para, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: para }, i))
								}),
								p.links && p.links.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-[2rem] border border-border bg-secondary/40 p-10 md:p-16 text-center",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "mx-auto max-w-2xl font-display text-3xl leading-tight md:text-5xl",
								children: "Chcete podpořit moji cestu nebo se jen ozvat?"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-6 mx-auto max-w-xl text-lg text-muted-foreground",
								children: "Napište mi. Každá zpráva, doporučení i drobná pomoc má pro mě hlubokou cenu."
							}),
